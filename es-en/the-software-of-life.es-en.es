...
Consideremos la vieja pregunta metafísica : ¿ acaso un barco de madera cuyas planchas se van reemplazando gradualmente a medida que se pudren sigue siendo el mismo barco después de que se han cambiado todas las planchas ?  
...
Al igual que un programa de computación , el Dna no conserva el estado final de lo que codifica ; más bien , plasma de una forma simbólica pero concreta ( es un " texto " real ) las relaciones entre todos los objetos y agentes que especifica y controla .  
Una observación extraordinaria apoya esta analogía : los virus se comportan como partes individuales de un programa , utilizando a las células como la máquina que necesitan para multiplicarse y posteriormente propagarse ( a menudo mediante la destrucción de la máquina ) .  
