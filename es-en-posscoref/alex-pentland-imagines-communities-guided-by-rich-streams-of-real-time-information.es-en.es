Datos vivos masivos  
Cambridge - Los datos masivos se crean a partir del rastro digital que dejamos cuando dummy-we usamos tarjetas de crédito , teléfonos celulares o Internet .  
Usados de forma precisa y minuciosa , estos datos nos dan un alcance sin precedentes para entender nuestra sociedad y mejorar la manera en que dummy-we vivimos y trabajamos .  
...
Sin conocer todas las alternativas posibles , no dummy-we podemos crear un conjunto limitado , comprobable y claro de hipótesis .  
Además , si ya no dummy-we podemos depender de experimentos de laboratorio para probar la causalidad , dummy-we tenemos que probarla en el mundo real , mediante el uso masivo de datos en tiempo real .  
...
Para observar cómo funcionan las cosas en realidad , dummy-we tenemos que construir laboratorios - dummy-nonhum es decir , comunidades dispuestas a intentar nuevos métodos ( francamente , actuar como conejillos de indias ) .  
Un ejemplo de un laboratorio vivo como se explicó antes es la " ciudad de datos abiertos " , que lancé conjuntamente con la ciudad de Trento , Italia , y la participación de Telecom italia , Telefónica , la Fundación de investigación ( Fondazione bruno kessler ) , el Instituto de programación orientada por datos ( Institute for Data driven design ) y compañías locales .  
...
Por ejemplo , mi laboratorio de Trento probará " el nuevo acuerdo sobre los datos " , que propuse , y ofrece a los usuarios un mejor control de su-nonhum-sg datos personales mediante redes de software confiables como nuestro sistema abierto " Personal data store " - Pds , por su-nonhum-sg siglas en inglés - ( almacenamiento de datos personales ) .  
dummy-we Esperamos que la capacidad de compartir datos de forma segura , sin sacrificar la protección de nuestra privacidad , aliente a los individuos , compañías y gobiernos a comunicar su-nonhum-sg ideas ampliamente , y aumentar la productividad y creatividad en toda la ciudad .  
...
Aunque los datos continuos y densos y la computación moderna nos permiten describir muchos detalles sobre nuestra sociedad , y explicar cómo podrían funcionar las comunidades , dichos modelos matemáticos dummy-they contienen demasiadas variables y relaciones complejas como para que la mayoría de las personas los entiendan .  
...
Solamente mediante el desarrollo de la ciencia y lenguaje de la física social dummy-we podremos construir el mundo de datos masivos en el que dummy-we queremos vivir .  
